...
const CartProject = () => {
  ...
  return (
    <div className="flex flex-3 justify-between my-4 gap-6 flex-wrap">
      {projectData.map((item, index) => (
        <div
          key={index}
          className="group relative max-w-[380px] p-6 border border-green-400 rounded-lg shadow-md transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl"
        >
          {/* Project Type */}
